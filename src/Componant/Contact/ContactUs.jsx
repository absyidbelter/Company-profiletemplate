        ...
        <div className="item w-40">
          ...
          <div className="flex ">
            ...
            <div className="item contact-info mt-30">
              ...
              <div className="flex">
                <div className="item">
                  <i  className="icon"><FontAwesomeIcon icon={faPhone}/></i> <a href="tel:00 7625 98626">00 7625 98626</a>
                </div>
                <div className="item">
                  <i className="icon"> <FontAwesomeIcon icon={faEnvelope}  /></i> <a href="mainto:00 7625 98626">info@info.com</a>
                </div>
              </div>
              ...
              <div className="flex mt-30">
                <div className="item">
                  <i className="icon"> <FontAwesomeIcon icon={faMap}  /></i> <a href="">adress of caompany can be here</a>
                </div>
                <div className="item">
                  <i className="icon"> <FontAwesomeIcon icon={faFax} /> </i> <a href="">00 7625 98626</a>
                </div>
              </div>
